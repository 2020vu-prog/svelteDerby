...
<h5>Racer: {getDriverName(Number(carNumber1))}</h5>
    <label>
    Lane 1 Won by 
        <input type="number" bind:value={resultForm.lane1} placeholder="Lane1[{carNumber1}] MS"/>
         MS
    </label>
...
<h5>Racer: {getDriverName(Number(carNumber2))}</h5>
    <label>
    Lane 2 Won by 
        <input type="number" bind:value={resultForm.lane2} placeholder="Lane2[{carNumber2}] MS"/>
         MS
    </label>
