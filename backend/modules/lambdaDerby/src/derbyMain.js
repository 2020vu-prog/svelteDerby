...
const routeMap = {
    ...
    "/addChart": { h: async (event) => { return buildResponse(await addChartMetaData(JSON.parse(event.body))); } },
    "/addChartPosition": { h: async (event) => { return buildResponse(await addChartPosition(JSON.parse(event.body))); } },
